SELECT Razao_Social, `DATA`, REG_ANS, DESCRICAO, VL_SALDO_INICIAL, VL_SALDO_FINAL, GASTO_TOTAL_ULT_TRIMESTRE_2024, RANKING
FROM(
    ...
    SELECT 
        ...
        GASTO_TOTAL_ULT_TRIMESTRE_2024,
        GASTO_NUMERICO,
    ...
    FROM (
        ...
        SELECT
            ...
            -- POIS, HÁ TRIMESTRE EM QUE O SALDO INICIAL É DIFERENTE DO SALDO FINAL DO TRIMESTRE PASSADO, LOGO NÃO DEVE SER COMPARADO COM OS VALORES
            ...
            FORMAT(
                SUM(
                    CASE 
                        ...
                        ELSE 0 
                    END
                ) OVER (PARTITION BY REG_ANS), 2) AS GASTO_TOTAL_ULT_TRIMESTRE_2024 -- FORMATADO PARA MELHOR LEGIBILIDADE
